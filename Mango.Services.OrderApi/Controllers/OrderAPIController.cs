    ...
    public class OrderAPIController : ControllerBase
    {
        ...
        public ResponseDto? Get(string? userId = "")
        {
            try
            {
                ...
                if (User.IsInRole(OrderStatu.RoleAdmin))
                {
        ...
        public async Task<ResponseDto> CreateOrder([FromBody] CartDto cartDto)
        {
            try
            {
                ...
                orderHeaderDto.OrderTime = DateTime.Now.ToString();
                orderHeaderDto.Status = OrderStatu.Status_Pending;
        ...
        public async Task<ResponseDto> ValidateStripeSession([FromBody] int orderHeaderId)
        {
            try
            {
                ...
                if (paymentIntent.Status == "succeeded")
                {
                    ...
                    orderHeader.Status = OrderStatu.Status_Approved;
                    _db.SaveChanges();
        ...
        public async Task<ResponseDto> UpdateOrderStatus(int orderId, [FromBody] string newStatus)
        {
            try
            {
                ...
                if (orderHeader != null)
                {
                    if (newStatus == OrderStatu.Status_Cancelled)
                    {
                        //we will give refund
